...
ch2_application1[, tradehat_bln := predict(fit_baseline_app1)]
...
ch2_application1[, tradehat_cfl := predict(fit_counterfactual_app1)]
...
while (sd_dif > 1e-5 | max_dif > 1e-5) {
  ...
  ch2_application1[, tradehat_1 := predict(fit_counterfactual_app1_2)]
...
```{r ch2_app2_costs_4}
ch2_application2_2[, tij_no_rta := predict(fit_costs_app2, ch2_application2_2)]
...
ch2_application2[, tradehat_bln := predict(fit_constrained_app2)]
...
ch2_application2[, tradehat_cfl := predict(fit_counterfactual_app2)]
...
while (sd_dif > 1e-3 | max_dif > 1e-3) {
  ...
  # compute the conditional general equilibrium effects of trade
  ch2_application2[, tradehat_1 := predict(fit_counterfactual_app2_2)]
