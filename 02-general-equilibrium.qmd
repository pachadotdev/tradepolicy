...
fe_exporter_bln <- fixef(fit_baseline_app1)$exporter %>%
  tibble::enframe(name = "exporter", value = "fe_exporter_bln")

fe_importer_bln <- fixef(fit_baseline_app1)$importer %>%
...
fe_exporter_cfl <- fixef(fit_counterfactual_app1)$exporter %>%
  tibble::enframe(name = "exporter", value = "fe_exporter_cfl")

fe_importer_cfl <- fixef(fit_counterfactual_app1)$importer %>%
...
while (sd_dif > 1e-5 | max_dif > 1e-5) {
  ...
  fe_exporter_cfl_1 <- fixef(fit_counterfactual_app1_2)$exporter %>%
    tibble::enframe(name = "exporter", value = "fe_exporter_cfl_1")

  fe_importer_cfl_1 <- fixef(fit_counterfactual_app1_2)$importer %>%
