...
## Changes concerning the fourth edition

The models were fitted using [capybara](github.com/pachadotdev/capybara), a new package created to fit gravity models more efficiently. It uses the rmadillo C++ library for a balance between speed and memory usage.

All the tables and statistics are shown step by step instead of relying on internal functions.

## Changes concerning the fifth edition

I am now using `data.table` instead of `dplyr` and `tidyr`. I think this offers a more stable set of functions for data analysis and somehow a more collaborative software governance.

## Contact

Please send me an email to *m.vargas.sepulveda* _[at]_ *gmail.com* if you have any questions.
