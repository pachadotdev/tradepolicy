...
ch1_application1_2 <-  tp_data("ch1_application1") %>%
...
ch1_app1_ols_remoteness <- tp_model_summary(
  formula = "log_trade ~ log_dist + cntg + lang + clny + log_y + log_e +
...
ch1_app1_ppml <- tp_model_summary(
