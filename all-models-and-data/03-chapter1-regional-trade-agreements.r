...
ch1_application3_2 <- tp_table("ch1_application3") %>%
...
ch1_app3_intra <- tp_summary_rtas(
  formula = "trade ~ 0 + log_dist + cntg + lang + clny +
...
ch1_app3_phsng <- tp_summary_rtas(
...
ch1_app3_glbzn <- tp_summary_rtas(
  formula = "trade ~ 0 + rta + rta_lag4 + rta_lag8 + rta_lag12 +
