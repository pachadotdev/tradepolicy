...
ch1_application3_2 <- tp_data("ch1_application3") %>%
...
ch1_app3_ols <- tp_model_summary3(
...
ch1_app3_ppml <- tp_model_summary3(
...
ch1_app3_intra <- tp_model_summary3(
  formula = "trade ~ 0 + log_dist + cntg + lang + clny +
...
ch1_app3_endg <- tp_model_summary3(
...
ch1_app3_lead <- tp_model_summary3(
...
ch1_app3_phsng <- tp_model_summary3(
...
ch1_app3_glbzn <- tp_model_summary3(
  formula = "trade ~ 0 + rta + rta_lag4 + rta_lag8 + rta_lag12 +
