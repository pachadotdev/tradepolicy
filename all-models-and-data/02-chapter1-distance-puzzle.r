...
ch1_application2_2 <- tp_data("ch1_application2") %>%
...
ch1_app2_ols <- tp_model_summary2(
...
ch1_app2_ppml <- tp_model_summary2(
...
ch1_app2_intra <- tp_model_summary2(
  formula = "trade ~ 0 + log_dist_1986 + log_dist_1990 +
    log_dist_1994 + log_dist_1998 + log_dist_2002 + log_dist_2006 +
...
ch1_app2_home <- tp_model_summary2(
  formula = "trade ~ 0 + log_dist_1986 + log_dist_1990 +
    log_dist_1994 + log_dist_1998 + log_dist_2002 + log_dist_2006 +
