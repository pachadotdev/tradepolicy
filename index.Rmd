...
`tradepolicy` is an R package created specifically to distribute the datasets required to reproduce the results from AGTPA. It acts as a metapackage that calls other packages to use several functions that augment R capabilities.
