...
Policy Analysis, AGTPA [@yotov2016advanced].

This material is intended to provide a comprehensive explanation to reproduce 
the book's results in R. We don’t attempt to give a thorough discussion of the 
theory behind gravity models, the references cited through the chapters shall 
fill those details.
...
`tradepolicy` is an R package created specifically to distribute the datasets 
required to reproduce the results from AGTPA. It acts as a metapackage that 
calls other packages to use several functions that augment R capabilities.
